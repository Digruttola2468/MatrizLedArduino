...
//PIN
#define DATA  8    // DIN pin del modulo MAX7219
#define LOAD  9    // CS pin del modulo MAX7219
#define CLOCK 10   // CLK pin del modulo MAX7219

#define DHTPIN 50  // PIN DHT11

//Variable MaxMatrix
int maxInUse = 4;    // Cambie este valor dependiendo del numero de matrices que use
byte buffer[2];
char mensaje1[] =  "CUMBIA 420     "; // Escriba el mensaje a desplegar 
...
void setup(){
  ...
  pinMode(DHTPIN,OUTPUT);   // Definimos como salida el pin
}
